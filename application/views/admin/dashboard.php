        ...
        <div class="row">
                    ...
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="text-uppercase mt5 clearfix"><i
                                    class="fa fa-money ftlayer"></i><?php echo $this->lang->line('fees') . " " . $this->lang->line('awaiting') . " " . $this->lang->line('payment'); ?><span
                                    class="pull-right"><?php echo $total_paid; ?>/<?php echo $total_fees ?></span>
                            </p>
            ...
            if ($this->rbac->hasPrivilege('staff_present_today_widegts', 'can_view')) {
                ...
                <div class="<?php echo $std_graphclass; ?>">
                    <div class="topprograssstart">
                        <p class="text-uppercase mt5 clearfix"><i
                                class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('staff') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?><span
            ...
            if ($this->module_lib->hasActive('student_attendance') && $sch_setting->attendence_type == 0) {
                if ($this->rbac->hasPrivilege('student_present_today_widegts', 'can_view')) {
                    ...
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="text-uppercase mt5 clearfix"><i
                                    class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('student') . ' ' . $this->lang->line('present') . ' ' . $this->lang->line('today'); ?><span
                                    class="pull-right">
                                    <?php echo 0 + $attendence_data['total_half_day'] + $attendence_data['total_late'] + $attendence_data['total_present']; ?>/<?php echo $total_students; ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
                                    <?php
                                    $att_half = isset($attendence_data['total_half_day']) ? intval($attendence_data['total_half_day']) : 0;
                                    $att_late = isset($attendence_data['total_late']) ? intval($attendence_data['total_late']) : 0;
                                    $att_present = isset($attendence_data['total_present']) ? intval($attendence_data['total_present']) : 0;
                                    $present_count = $att_half + $att_late + $att_present;
                                    $student_total = isset($total_students) ? intval($total_students) : 0;
                                    $student_percent = ($student_total > 0) ? ($present_count * 100) / $student_total : 0;
                                    ?>
                                    <div class="progress-bar progress-bar-yellow"
                                        style="width: <?php echo round($student_percent, 2); ?>%"></div>
                                </div>
                            </div>
                        </div><!--./topprograssstart-->
                    </div><!--./col-md-3-->
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        ...
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title">
                                    <?php echo $this->lang->line('fees_collection_&_expenses_for'); ?>        <?php echo $this->lang->line('_expenses_for') ?>         <?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y');
                                                           ;
                                                           ?></h3>
                ...
                if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        ...
                        <div class="box box-info borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title"><?php echo $this->lang->line('fees_collection_&_expenses_for_session'); ?>
                                    <?php echo $this->setting_model->getCurrentSessionName(); ?></h3>
                                <div class="box-tools pull-right">
                                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                                </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            <h5 class="pro-border pb10">
                                <?php echo $this->lang->line('fees') . " " . $this->lang->line('overview') ?></h5>
                            <p class="text-uppercase mt10 clearfix"><?php echo $fees_overview['total_unpaid']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $fees_overview['total_partial']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $fees_overview['total_paid']; ?>
            ...
            if ($this->module_lib->hasActive('front_office')) {
                if ($this->rbac->hasPrivilege('enquiry_overview_widegts', 'can_view')) {
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            <h5 class="pro-border pb10">
                                <?php echo $this->lang->line('enquiry') . " " . $this->lang->line('overview'); ?></h5>
                            <p class="text-uppercase mt10 clearfix"><?php echo $enquiry_overview['active']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $enquiry_overview['won']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $enquiry_overview['passive']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $enquiry_overview['lost']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $enquiry_overview['dead']; ?>
            ...
            if ($this->module_lib->hasActive('library')) {
                if ($this->rbac->hasPrivilege('book_overview_widegts', 'can_view')) {
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            <h5 class="pro-border pb10">
                                <?php echo $this->lang->line('library') . " " . $this->lang->line('overview'); ?></h5>
                            <p class="text-uppercase mt10 clearfix"><?php echo $book_overview['dueforreturn']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $book_overview['forreturn']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $book_overview['total_issued']; ?>
                                <?php echo $this->lang->line('issued_out_of'); ?>         <?php echo $book_overview['total'] ?><span
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $book_overview['availble']; ?>
                                <?php echo $this->lang->line('available_out_of') ?>         <?php echo $book_overview['total']; ?><span
                ...
                if ($this->rbac->hasPrivilege('today_attendance_widegts', 'can_view')) {
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $attendence_data['total_present']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $attendence_data['total_late']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $attendence_data['total_absent']; ?>
                            ...
                            <p class="text-uppercase mt10 clearfix"><?php echo $attendence_data['total_half_day']; ?>
                                    ...
                                    <div class="info-box">
                                        <a href="<?php echo site_url('studentfee') ?>">
                                            ...
                                            <div class="info-box-content">
                                                <span
                                                    class="info-box-text"><?php echo $this->lang->line('monthly_fees_collection'); ?></span>
                                                <span
                                                    class="info-box-number"><?php echo $currency_symbol . $month_collection; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="info-box">
                                        <a href="<?php echo site_url('admin/expense') ?>">
                                            ...
                                            <div class="info-box-content">
                                                <span
                                                    class="info-box-text"><?php echo $this->lang->line('monthly_expenses'); ?></span>
                                                <span
                                                    class="info-box-number"><?php echo $currency_symbol . $month_expense; ?></span>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <form role="form" id="addevent_form" method="post" enctype="multipart/form-data" action="">
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('event'); ?>
                                <?php echo $this->lang->line('title'); ?></label><small class="req"> *</small>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label
                                    for="exampleInputEmail1"><?php echo $this->lang->line('event') . " " . $this->lang->line('from') ?></label>
                            ...
                            <div class="form-group col-md-6">
                                <label
                                    for="exampleInputEmail1"><?php echo $this->lang->line('event') . " " . $this->lang->line('to') ?></label>
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </div>
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('event'); ?>
                                <?php echo $this->lang->line('color'); ?></label>
...
<div id="viewEventModal" class="modal fade " role="dialog">
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('edit') ?> <?php echo $this->lang->line('event') ?>
                </h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <form role="form" method="post" id="updateevent_form" enctype="multipart/form-data" action="">
                        <div class="form-group col-md-12">
                            <label
                                for="exampleInputEmail1"><?php echo $this->lang->line('event') ?><?php echo $this->lang->line('title') ?></label>
                        ...
                        <div class="form-group col-md-12">
                            <label
                                for="exampleInputEmail1"><?php echo $this->lang->line('event') ?><?php echo $this->lang->line('color') ?></label>
                        ...
                        <div class="form-group col-md-12">
                            <label
                                for="exampleInputEmail1"><?php echo $this->lang->line('event') ?><?php echo $this->lang->line('type') ?></label>
                            <label class="radio-inline">
